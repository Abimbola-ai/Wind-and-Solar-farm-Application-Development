...
less_data = final_merged_data[(final_merged_data.Power_Solar <= 4.0) | (final_merged_data.Power_Wind <= 4.0)]
#print(final_merged_data)
#print(less_data)
...
days = less_data['Day'].tolist()
current_timestamp = str(datetime.now())

messages = f"THIS is UPDATED REPORT at {current_timestamp}"
#for day in days
for day in days:
    each_row = less_data[less_data['Day'] == days]
